...
import (
	...
	"github.com/rhacker/go-examples/examples/bookmark-api/model"
	"github.com/rhacker/go-examples/examples/bookmark-api/store"
	utils "github.com/rhacker/go-examples/examples/bookmark-api/webutils"
)
